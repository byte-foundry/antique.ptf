exports.glyphs['dollar_alt'] =
	unicode: '$'
	glyphName: 'dollar'
	characterName: 'DOLLAR SIGN'
	altImg: 'alt-antique-dollar-1.svg'
	ot:
	...
	contours:
		...
		1:
			...
			nodes:
				...
				1:
					...
					y: ( contours[0].nodes[6].expandedTo[1].y + contours[0].nodes[6].expandedTo[0].y ) / 2
					typeOut: 'line'
					expand:
						width: ( 29 / 54 ) * thickness
						angle: 0 + 'deg'
		...
		2:
			...
			nodes:
				0:
					x: contours[0].nodes[2].x
					y: ( contours[0].nodes[2].expandedTo[1].y + contours[0].nodes[2].expandedTo[0].y ) / 2
					typeOut: 'line'
					expand:
						width: ( 29 / 54 ) * thickness
						angle: 0 + 'deg'
