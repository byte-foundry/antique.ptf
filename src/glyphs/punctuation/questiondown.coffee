	...
	contours:
		0:
			...
			nodes:
				0:
					...
					dirOut: 90 + 'deg'
					expand: Object({
						width: ( 88 / 54 ) * thickness * contrastExtremity
						angle: 6 + 'deg'
						distr: 0.25
					})
				1:
					...
					type: 'smooth'
					expand: Object({
						width: ( 54 / 54 ) * thickness * contrast
				...
				2:
					x: Math.max(
						...
						contours[0].nodes[0].expandedTo[1].x + 0.75 * ( 92 / 54 ) * thickness + 10
					)
		...
		1:
			...
			nodes:
				0:
					x: Math.max(
						contours[1].nodes[1].expandedTo[1].x - ( 16 / 54 ) * thickness,
		...
		2:
			...
			nodes:
				...
				1:
					...
					y: contours[0].nodes[0].expandedTo[0].y - ( 40 / 54 ) * thickness
					typeOut: 'line'
				2:
					x: Math.max(
				...
				3:
					...
					y: Math.min(
						contours[2].nodes[2].y + ( 10 / 54 ) * thickness,
